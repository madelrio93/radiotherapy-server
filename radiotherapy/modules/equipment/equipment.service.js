...
let EquipmentService = class EquipmentService extends shared_1.CommonService {
    constructor(_equipmentRepository) {
...
EquipmentService = __decorate([
    common_1.Injectable(),
    __param(0, typeorm_1.InjectRepository(equipment_entity_1.Equipment)),
