...
let OriginService = class OriginService extends shared_1.CommonService {
    constructor(_originRepository) {
        super(_originRepository);
        this._originRepository = _originRepository;
    }
};
OriginService = __decorate([
    common_1.Injectable(),
    __param(0, typeorm_1.InjectRepository(origin_entity_1.Origin)),
