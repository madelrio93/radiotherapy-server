...
const origin_resolver_1 = require("./origin.resolver");
const origin_entity_1 = require("./entities/origin.entity");
let OriginModule = class OriginModule {
};
OriginModule = __decorate([
    common_1.Module({
        imports: [typeorm_1.TypeOrmModule.forFeature([origin_entity_1.Origin])],
        providers: [origin_resolver_1.OriginResolver, origin_service_1.OriginService],
    })
], OriginModule);
