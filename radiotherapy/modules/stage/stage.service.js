...
let StageService = class StageService extends shared_1.CommonService {
    constructor(_stageRepository) {
        super(_stageRepository);
        this._stageRepository = _stageRepository;
    }
};
StageService = __decorate([
    common_1.Injectable(),
    __param(0, typeorm_1.InjectRepository(stage_entity_1.Stage)),
